...
{
    public class DeleteCommentHandler : RequestHandlerBase<DeleteComment, bool>
    {
        public DeleteCommentHandler(DataContext dataContext)
            : base(dataContext) { }

        protected override async Task ExecuteRequestAsync(DeleteComment request)
        {
